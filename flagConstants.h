...
const QVector<QString> CHRISTIANITY_FLAGS = {"nz.png", "dm.png", "no.png", "es.png", "se.png", "ax.png","dk.png","to.png", "gb-eng.png","is.png","ws.png","au.png"};
const QVector<QString> ISLAM_FLAGS = {"af.png", "az.png", "pk.png", "my.png", "tr.png", "km.png", "mr.png","sa.png"};
const QVector<QString> UNION_JACK_FLAGS = {"au.png", "nz.png", "tv.png", "fj.png", "vg.png", "gb-nir.png","fk.png","ck.png","bm.png","nu.png","gs.png","io.png", "ky.png"};
