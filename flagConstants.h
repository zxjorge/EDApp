...
const QVector<QString> CHRISTIANITY_FLAGS = {"nz.png", "dm.png", "me.png", "no.png", "es.png", "se.png", "ax.png","dk.png","to.png", "gb-eng.png"};
const QVector<QString> ISLAM_FLAGS = {"af.png", "az.png", "pk.png", "my.png", "tr.png", "km.png", "cc.png", "mr.png"};
const QVector<QString> UNION_JACK_FLAGS = {"au.png", "nz.png", "tv.png", "fj.png", "vg.png", "gb-nir.png"};
