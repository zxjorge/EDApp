...
const QVector<QString> CHRISTIANITY_FLAGS = {"nz.png", "dm.png", "no.png", "se.png", "ax.png","dk.png","to.png", "gb-eng.png","is.png","ws.png","au.png","cc.png","fj.png","gr.png","do.png","ch.png","tk.png","fi.png"};
const QVector<QString> ISLAM_FLAGS = {"af.png", "az.png", "pk.png", "my.png", "tr.png", "km.png", "mr.png","sa.png","cc.png","ly.png","tn.png"};
